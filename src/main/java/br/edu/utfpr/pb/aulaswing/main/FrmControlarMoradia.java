...
import br.edu.utfpr.pb.aulaswing.tableModel.MoradiaTableModel;
 ...
 */
public class FrmControlarMoradia extends javax.swing.JInternalFrame {
    private MoradiaTableModel moradiaTableModel;
    
    /**
     * Creates new form FrmControlarMoradia
     */
    public FrmControlarMoradia() {
        initComponents();
        carregarDados();
    }
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        FrmCadastroMoradia frm = 
                new FrmCadastroMoradia(null, true);
        ...
        try {
            if (tblDados.getSelectedRow() >= 0){
                ...
                if (JOptionPane.showConfirmDialog(
                    ...
                    moradiaController.remover(id);
                    //carregarDados(); //OU
                    moradiaTableModel.removeRow(
    ...
    private void carregarDados() {
        MoradiaController controller = 
                new MoradiaController();
        moradiaTableModel = new MoradiaTableModel(
                        controller.listar() );
        
        tblDados.setModel(moradiaTableModel);
        moradiaTableModel.fireTableDataChanged();
    }
}
