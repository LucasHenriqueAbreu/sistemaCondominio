 ...
 * @author Vinicius
 */
public class FrmControlarUsuario extends javax.swing.JInternalFrame {
    private UsuarioTableModel usuarioTableModel;
    
    /**
     * Creates new form FrmControlarProduto
     */
    public FrmControlarUsuario() {
        initComponents();
        carregarDados();
    }
    ...
    private void btnIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirActionPerformed
        FrmCadastroUsuario frm = 
                new FrmCadastroUsuario(null, true);
