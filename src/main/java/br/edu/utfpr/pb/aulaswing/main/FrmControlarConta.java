...
import br.edu.utfpr.pb.aulaswing.tableModel.ContaTableModel;
 ...
 */
public class FrmControlarConta extends javax.swing.JInternalFrame {
    private ContaTableModel contaTableModel;
    
    /**
     * Creates new form FrmControlarConta
     */
    public FrmControlarConta() {
        initComponents();
        carregarDados();
    }
        ...
        try {
            if (tblDados.getSelectedRow() >= 0){
                ...
                if (JOptionPane.showConfirmDialog(
                    ...
                    contaTableModel.getValueAt(
                     tblDados.getSelectedRow(),0).toString());
                    ContaController ContaController = 
                               new ContaController();
                    ContaController.remover(id);
                    //carregarDados(); //OU
                    contaTableModel.removeRow(
    ...
    private void carregarDados() {
        ContaController controller = 
                new ContaController();
        contaTableModel = new ContaTableModel(
                        controller.listar() );
        
        tblDados.setModel(contaTableModel);
        contaTableModel.fireTableDataChanged();
    }
}
